...
const getStartListRace = async (req, res) => {
    ...
    const startlist = await db.query(
        "SELECT ri.id as rider_id, ri.nationality as rider_nationality, ri.name as rider_name, t.id as team_id, t.name as team_name, t.nationality as team_nationality " +
        "FROM startlists st " +
